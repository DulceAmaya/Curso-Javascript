...
Por último vamos a verificar el número de intento pues, el jugador solo cuenta con 6 intentos para adivinar, por lo que si la variable `intentos` es igual a 7, el jugador perderá el juego.
