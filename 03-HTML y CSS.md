...
HTML **no** es un lenguaje de programación, por lo que no es posible crear funcionalidades dinámicas, para esto utilizamos JavaScript como veremos más adelante. HTML se encarga de organizar el contenido y de decirle al navegador como deberá desplegarlo.
